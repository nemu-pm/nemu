  ...
  return (
    <div
      ...
      className={cn(
        ...
        "[[data-slot=combobox-content]_&]:focus-within:border-inherit [[data-slot=combobox-content]_&]:focus-within:shadow-none",
        className
      )}
      {...props}
    />
...
function InputGroupInput({
  ...
  return (
    <Input
      ...
      className={cn(
        // Reset styling for nested input (handled by CSS, but Tailwind backup)
...
function InputGroupTextarea({
  ...
  return (
    <Textarea
      data-slot="input-group-control"
      className={cn(
        // Reset styling for nested textarea (handled by CSS, but Tailwind backup)
