"""Text detection inference module."""
import json
...
from .utils.textmask import refine_mask, refine_undetected_mask, REFINEMASK_INPAINT
...
class TextDetector:
    """Comic text detector using YOLOv5 + UNet segmentation."""
    ...
    def __call__(self, img, refine_mode=REFINEMASK_INPAINT, keep_undetected_mask=False):
        img_in, ratio, dw, dh = preprocess_img(
            img, input_size=self.input_size, device=self.device, 
